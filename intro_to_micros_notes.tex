...
\include{./tex/cpu}
\include{./tex/coding}
\include{./tex/load-store}
\include{./tex/branching}
\include{./tex/conditional_branch}
\include{./tex/subroutines}
\include{./tex/peripherals}
\include{./tex/rcc}
\include{./tex/gpio}
\include{./tex/instruction_sets}
\include{./tex/exceptions}
\include{./tex/stack}
\include{./tex/adc}
\include{./tex/timer}
\include{./tex/nvic}
\include{./tex/c_intro}
\include{./tex/c_vars}
\include{./tex/c_operators}
\include{./tex/conditional}
\include{./tex/loops}
\include{./tex/functions}
\include{./tex/multi-file-projects}
