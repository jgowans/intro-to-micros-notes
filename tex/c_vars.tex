...
We frequently only need a variable for some a short duration, such as when some function is called so that the variable can be used for sotring intermediate data needed in the algorithm of the function.
